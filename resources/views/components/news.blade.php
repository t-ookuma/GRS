    ...
    <div class="p-3">
        <div class="overflow-x-auto">
            <table class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-gray-900 bg-white-op">
                    <tr>
...
<div class="flex justify-center">
    <div class="container mt-4 max-w-xl h-52 rounded-lg text-gray-900 bg-opacity-50 bg-white-op">
        <div class="p-4">
            {{ $news }}
        </div>
    </div>
